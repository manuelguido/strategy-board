...
export const NODE_TYPES: NodeTypeDef[] = [
    { type: 'api', label: 'API', icon: 'Globe', accent: 'hsl(225 65% 70%)' },
    {
        ...
        label: 'Service',
        icon: 'Box',
        accent: 'hsl(265 40% 70%)',
    },
    {
        type: 'database',
        label: 'Database',
        icon: 'Database',
        accent: 'hsl(160 35% 60%)',
    },
    {
        type: 'queue',
        label: 'Queue',
...
export const NODE_TYPE_MAP: Record<NodeType, NodeTypeDef> = Object.fromEntries(
...
export const EDGE_TYPES: EdgeTypeDef[] = [
    {
        ...
        width: 1.5,
        color: 'hsl(225 45% 62%)',
        description: 'Blocking request/response.',
    },
    {
        type: 'async',
        label: 'Async event',
        ...
        width: 1.5,
        color: 'hsl(265 35% 65%)',
        description: 'Fire-and-forget message.',
    },
    {
        type: 'read',
        label: 'Read',
        ...
        width: 1.25,
        color: 'hsl(160 30% 55%)',
        description: 'Reads from data store.',
    },
    {
        type: 'write',
        label: 'Write',
        ...
        width: 2,
        color: 'hsl(35 50% 58%)',
        description: 'Writes to data store.',
    },
    {
        type: 'dependency',
        label: 'Dependency',
        ...
        width: 1,
        color: 'hsl(220 8% 50%)',
        description: 'Hard structural dependency.',
    },
];

export const EDGE_TYPE_MAP: Record<EdgeType, EdgeTypeDef> = Object.fromEntries(
    EDGE_TYPES.map((d) => [d.type, d]),
) as Record<EdgeType, EdgeTypeDef>;
...
export function isEdgeAllowed(
    ...
    if (
        edgeType === 'sync' &&
        (targetType === 'queue' || targetType === 'database')
    ) {
        return false;
    }
...
export const SAMPLE_BOARD: BoardState = {
    ...
    nodes: [
        {
            ...
            height: 70,
            metadata: {
                endpoints: ['POST /checkout', 'GET /orders/:id'],
                auth: 'jwt',
            },
            tags: ['public'],
            domain: 'checkout',
        ...
        },
        {
            ...
            metadata: {
                broker: 'kafka',
                topics: ['order.created', 'payment.settled'],
            },
            tags: [],
            domain: 'platform',
        },
    ...
    edges: [
        ...
        },
        {
            ...
            source: 'n_q',
            target: 'n_worker',
            metadata: { retry: 'exponential', retryMax: 5 },
        },
        {
            id: 'e8',
            type: 'sync',
